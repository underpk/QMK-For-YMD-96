...
qk_tap_dance_action_t tap_dance_actions[] = {
 ...
 // Idea and to do list for tap dance
 // 3 ESC ALT F4
 // 2 WIN Explorer
 // 2 END Mute
 // 2 HOME Pause
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	*/
    ...
    [_DEFLT] = KEYMAP(
		...
		KC_ESC,  	KC_F1,  	KC_F2,   KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,   KC_F9,  	KC_F10, 	KC_F11,     KC_F12,     KC_PSCR, 	 TD(CT_PRN),  KC_NUMLOCK,   KC_HOME, KC_END, 	KC_PGUP, 	\
